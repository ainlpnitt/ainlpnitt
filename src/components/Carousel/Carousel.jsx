...
const elements = [
  {
    src: "/images/gallery/ai_lang_pro_2024/16.jpg",
    description: "Snap of AI Lang Pro Event 2024: Financial Relation Prediction",
  },
  {
    src: "/images/gallery/ai_lang_pro_2024/15.jpg",
    description: "AI Lang Pro 24 1st Prize",
  },
  {
    src: "/images/gallery/ai_lang_pro_2024/13.jpg",
    description: "AI Lang Pro 24 2nd Prize",
  },
  {
    src: "/images/gallery/ai_lang_pro_2024/14.jpg",
...
const CarouselElement = () => {
  return (
    <div className="mx-auto max-w-[90vw] sm:max-w-[70vw]">
      <Carousel autoplay className="h-[60vh] sm:h-[50vh] lg:h-[70vh]">
        {carouselElements}
      </Carousel>
    </div>
  );
